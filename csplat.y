...
| WRITE L_PAREN param_list R_PAREN {printf("stmt -> WRITE L_PAREN param_list R_PAREN\n");}
| READ L_PAREN param_list R_PAREN {printf("stmt -> READ L_PAREN param_list R_PAREN\n");}
